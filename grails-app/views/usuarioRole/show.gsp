...
<html>
    ...
    <body>
        ...
        <div id="show-usuarioRole" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarioRole" />
            <g:form resource="${this.usuarioRole}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarioRole}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
